    ...
    <>
        <div className=' z-20 relative esas_container'>
            ...
            <div className=' pt-5'></div>
                <div className='text-lg esas_txt font-semibold'>PROGRAMS</div>
            ...
            <div className=" py-4 space-y-1 font-semibold text-md border esas_border rounded-md items-center px-2">
                ...
                <div className="">
                    ...
                    <div className='flex  border esas_border rounded-b-2xl  border-t-0  pt-2 bg-transparent'>
                        ...
                        <SwiperSlide className=''>
                                <div className='flex w-full p-4 aspect-[9/3] '>
