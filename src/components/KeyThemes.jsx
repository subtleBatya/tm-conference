...
function KeyThemes() {
    return (
        <div className=' z-20 relative '>
            ...
            <div className=' pt-5'></div>
                <div className='text-lg font-semibold'>KEY THEMES</div>
  ...
  <div className="grid grid-cols-4 py-4 gap-0 font-semibold text-md border-2 rounded-md items-center px-7">
    ...
    <div className="px-1 col-span-2 h-full flex">
      <div className="bg-white flex items-center justify-center w-full px-2 py-3">
        ...
        <div className=" text-center items-center align-middle">
            <div className='border-t-6 rounded-t-2xl border-red-500 my-auto space-y-5 text-center items-center align-middle  aspect-[16/9] bg-gray-200/20'>
                <div>
                    <div className=" text-7xl font-bold text-blue-400  text-center align-middle items-center">01</div>
                    <div className=" capitalize">modern trends in public administration</div>
                </div>
            </div>
        </div>
